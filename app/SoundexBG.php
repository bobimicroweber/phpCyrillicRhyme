...
/**
 * Example
 * echo implode(' ', SoundexBG::dmstring('Калоян'))."\n";
echo implode(' ', SoundexBG::dmstring('Калуиан'))."\n";
 */
class SoundexBG
{
    public static function dmword($string, $is_cyrillic = true)
    {
        static $codes = array(
            'A' => array(array(0, -1, -1),
                'I' => array(array(0, 1, -1)),
    ...
    public static function dmstring($string)
    {
        $is_cyrillic = false;
    ...
    public static function translit($string)
    {
        ...
        static $en = array(
            ...
            'S', 's', 'T', 't', 'U', 'u', 'F', 'f', 'H', 'h', 'C', 'c', 'Ch', 'ch', 'Sh', 'sh', 'Scht', 'scht',
            '\'', '\'', 'E', 'e', 'Ju', 'ju', 'Ja', 'ja'
        );

        $string = str_replace($bg, $en, $string);
        return $string;
    }
